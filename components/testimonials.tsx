        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-blue-888 rounded-2xl" data-aos="fade-up" data-aos-delay="200">
              ...
              <blockquote className="text-lg text-gray-200 tracking-[0.05em] grow italic" style={{ fontFamily: 'helvetica, sans-serif' }}>Trabajar con SaucoTec ha resultado en excelentes logros para Energía Global. La personalización de soluciones y su cercanía los diferencia, sabemos que siempre están dispuestos a ayudarnos ante cualquier requerimiento.</blockquote>
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
